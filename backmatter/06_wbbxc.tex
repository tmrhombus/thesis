...
If $d_{20}<m_{20}$, the QCD contribution is taken to be negligible. % and is scaled by $10^{-6}$.
...
\center
 \includegraphics[width=0.4\textwidth]{/Users/rhombus/CMS/Thesis/thesis/pdfs/feyn/stt/stt.pdf}
\label{fig:feynstt}
\end{figure}
...
The measured cross sections are compared to theoretical predictions from
 ...
 \MADGRAPH5 with \PYTHIAe \cite{ref:Pythia8} in the four-flavor scheme.
