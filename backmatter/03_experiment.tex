...
The measurement of the \ppwbb cross section 
 ...
 use 2.3~\fbinv of data collected at \s13~\TeV. 
...
The GMT uses information about the geometry and total energy 
 of hits in the RPC, CSC and DT systems collectively %individually 
...
%Information from the ECAL and HCAL were sent using 
% copper wires in 2012 and one part of the upgrade
% from 2012 to 2015 that I was involved with
% was in making the switch to fiber optic transmissions 
% for the ECAL. 
